...
def main():
    ...
    np.save(KERNEL_DIR / "bace_anchor_indices_pca4_n128.npy", anchor_idx)
    ...
    np.save(KERNEL_DIR / "bace_qanchor_train_pca4_n300_a128.npy", Z_train)
    np.save(KERNEL_DIR / "bace_qanchor_test_pca4_n100_a128.npy", Z_test)
    ...
    out_path = OUT_DIR / "bace_quantum_anchor_results_a128.csv"
