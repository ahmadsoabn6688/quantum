...
def main():
    ...
    np.save(KERNEL_DIR / "bace_anchor_indices_pca6_n64.npy", anchor_idx)

    print("Running 6-qubit anchor-based quantum kernel experiment")
    ...
    np.save(KERNEL_DIR / "bace_qanchor_train_pca6_n300_a64.npy", Z_train)
    np.save(KERNEL_DIR / "bace_qanchor_test_pca6_n100_a64.npy", Z_test)
    ...
    out_path = OUT_DIR / "bace_quantum_anchor_results_6q_a64.csv"
    results_df.to_csv(out_path, index=False)

    print("\n6-qubit quantum anchor result:")
    print(results_df)
    print(f"\nSaved to: {out_path}")
